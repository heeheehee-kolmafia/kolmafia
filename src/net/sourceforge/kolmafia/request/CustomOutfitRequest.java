...
public class CustomOutfitRequest extends GenericRequest {
  private static final Pattern LIST_PATTERN = Pattern.compile("<form name=manageoutfits.*?</form>");
  private static final Pattern ENTRY_PATTERN =
      Pattern.compile(
          "name=name([\\d]+) value=\"([^\"]*)\".*?<center><b>Contents:</b></cente[rR]>(.*?)</td>");
  ...
  private static final Pattern PREVIOUS_OUTFIT_PATTERN =
      Pattern.compile("<option value='(-\\d+)'>Your Previous Outfit</option>");
