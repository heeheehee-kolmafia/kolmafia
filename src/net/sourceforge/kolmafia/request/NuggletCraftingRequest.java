...
public class NuggletCraftingRequest extends CoinMasterRequest {
  ...
  public static final List<AdventureResult> buyItems =
      CoinmastersDatabase.getBuyItems(NuggletCraftingRequest.master);
  private static final Map<Integer, Integer> buyPrices =
      CoinmastersDatabase.getBuyPrices(NuggletCraftingRequest.master);
  private static final Map<Integer, Integer> itemRows =
      CoinmastersDatabase.getRows(NuggletCraftingRequest.master);
