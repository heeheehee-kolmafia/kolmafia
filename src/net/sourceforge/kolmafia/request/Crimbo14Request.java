...
public class Crimbo14Request extends CoinMasterRequest {
  ...
  private static final List<AdventureResult> buyItems =
      CoinmastersDatabase.getBuyItems(Crimbo14Request.master);
  private static final Map<Integer, Integer> buyPrices =
      CoinmastersDatabase.getBuyPrices(Crimbo14Request.master);
  private static final List<AdventureResult> sellItems =
      CoinmastersDatabase.getSellItems(Crimbo14Request.master);
  private static final Map<Integer, Integer> sellPrices =
      CoinmastersDatabase.getSellPrices(Crimbo14Request.master);
  ...
  private static final Map<Integer, Integer> itemRows =
      CoinmastersDatabase.getRows(Crimbo14Request.master);
