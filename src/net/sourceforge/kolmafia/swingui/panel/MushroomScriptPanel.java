...
public class MushroomScriptPanel extends JPanel {
  ...
  public void removeFromLayout() {
    this.centerPanel.invalidate();
    this.centerPanel.remove(
        this.currentForecast < 4 ? this.currentForecast - 1 : this.currentForecast);
  ...
  public void initializeLayout() {
    ...
    if (this.currentLayout.equals("")) {
      ...
      plantingLength =
          MushroomManager.loadLayout(this.currentLayout, this.originalData, this.planningData);
    ...
    for (int i = 0; i < this.currentForecast; ++i) {
      this.headers[i].setBackground(
          i == indexToHighlight
              ? MushroomScriptPanel.TODAY_COLOR
              : MushroomScriptPanel.OTHER_COLOR);
    }
  ...
  public void runLayout() {
    ...
    if (!this.currentLayout.equals("")) {
      KoLmafiaCLI.DEFAULT_SHELL.executeLine(
          "call " + KoLConstants.PLOTS_DIRECTORY + this.currentLayout + ".ash");
    }
  }
  ...
  private class MushroomButton extends JButton implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      MushroomScriptPanel.this.planningData[this.dayIndex][this.squareIndex] =
          this.toggleMushroom();
      MushroomScriptPanel.this.updateForecasts(this.dayIndex + 1);
    }

    public void updateImage() {
      String currentMushroom =
          MushroomScriptPanel.this.planningData[this.dayIndex][this.squareIndex];
      ...
      if (currentMushroom.equals("__")) {
        ...
        this.setIcon(
            JComponentUtilities.getImage(MushroomManager.getMushroomImage(currentMushroom)));
      }
